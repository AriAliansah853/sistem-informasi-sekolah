                            ...
                            <table class="table table-striped" id="table-2">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ route('siswa.show', Crypt::encrypt($data)) }}" class="btn btn-primary btn-sm" style="margin-right: 8px"><i class="nav-icon fas fa-user"></i> &nbsp; Profile</a>
                                                <a href="{{ route('siswa.edit', Crypt::encrypt($data)) }}" class="btn btn-success btn-sm"><i class="nav-icon fas fa-edit"></i> &nbsp; Edit</a>
                                                <form method="POST" action="{{ route('siswa.destroy', $data) }}">
                                                    @csrf
                                                    @method('delete')
