...
<<<<<<< HEAD
            ...
            <div class="card card-hero" style="margin-top: 36px">
                <div class="card-header">
                    ...
                    <h4>Notifikasi</h4>
                    <div class="card-description">Notifikasi absensi terbaru untuk orangtua</div>
                </div>
                <div class="card-body p-0">
                    <div class="tickets-list">
                        @if ($orangtua->notifications && $orangtua->notifications->count())
                            @foreach ($orangtua->notifications->take(5) as $notification)
                                <div class="ticket-item">
                                    <div class="ticket-title">
                                        <h4>{{ $notification->title }}</h4>
                                    </div>
                                    <div class="ticket-info">
                                        <div>{{ strlen($notification->message) > 80 ? substr($notification->message, 0, 80) . '...' : $notification->message }}</div>
                                        <div class="bullet"></div>
                                        <div class="text-primary">{{ $notification->created_at->format('d M Y') }}</div>
                                    </div>
                                </div>
                            @endforeach
                        @else
                ...
                <div class="card-footer text-center">
                    <a href="{{ route('orangtua.notifikasi') }}">Lihat semua notifikasi</a>
                </div>
            </div>
        </div>
        {{-- <div class="col-12 col-sm-12 col-lg-3">
